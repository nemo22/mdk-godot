...
use his chute through them with the original movement and camera. There are no aliens, weapons or
objects yet. See [the roadmap](docs/roadmap.md).
...
- `docs/gameplay.md`: movement, collision, camera and timing of the original game.
